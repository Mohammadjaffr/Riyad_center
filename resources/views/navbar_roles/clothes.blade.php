        <li class="nav-item w-100">
            <a class="nav-link text-white fw-bold d-lg-none d-md-flex" href="{{ route('dashboard.clothes') }}">لوحة ملابس</a>
        </li>
        <li class="nav-item position-relative w-100">
            @can('عرض المنتجات')
                <a class="nav-link text-white fw-bold d-lg-none d-md-flex" href="{{ route('products.index') }}">المنتجات</a>
            @endcan
        </li>

        <li class="nav-item position-relative w-100">
            @can('عرض المشتريات')
                <a class="nav-link text-white fw-bold d-lg-none d-md-flex" href="{{ route('purchases.index') }}">المشتريات</a>
            @endcan
        </li>
