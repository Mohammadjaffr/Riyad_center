        ...
        <div class="bg-white rounded-4 p-3 shadow-sm">
                ...
                <form method="GET" class="row g-3 mb-3">
                    ...
                    <div class="col-6 col-lg-3 ">
                        <select name="product_variant_id" class="summary-input text-end flex-grow-1 w-100 ">
                    ...
                    <div class="col-6 col-lg-3">
                        <select name="employee_id" class="summary-input text-end flex-grow-1 w-100 ">
                    ...
                    <div class="col-6 col-lg-2">
                        <input type="date" name="date_from" class="summary-input text-end flex-grow-1 w-100 " value="{{ request('date_from') }}">
                    </div>

                    <div class="col-6 col-lg-2">
                        <input type="date" name="date_to" class="summary-input text-end flex-grow-1 w-100 " value="{{ request('date_to') }}">
                    </div>
