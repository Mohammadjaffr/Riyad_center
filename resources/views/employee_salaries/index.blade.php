...
@section('content')
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
            ...
            <a href="{{ route('employee-salaries.create') }}" class="btn btn-blue mb-2 mb-md-0">
                <i class="fa fa-plus"></i>إضافة راتب
            </a>
        </div>
        <div class="bg-white rounded-4 p-3 shadow-sm mb-3">
            <div class="row g-2 align-items-center mb-3">
                <form method="GET" action="{{ route('employee-salaries.index') }}" class="col-md-6 col-lg-4 mb-3 mt-4">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded-4 bg-white">
                <div class="modal-header">
                    <h5 class="modal-title text-dark-blue" id="filterModalLabel">فلترة الرواتب</h5>
                </div>

                <form method="GET" action="{{ route('employee-salaries.index') }}">
                    <div class="modal-body">
                        <div class="row g-3 text-dark-blue">
                            ...
                            <!-- الترتيب حسب الراتب -->
                            <div class="col-md-6">
                                <label class="form-label fw-bold">الترتيب حسب الراتب</label>
                    ...
                    <div class="modal-footer justify-content-between">
                        <a href="{{ route('employee-salaries.index') }}" class="btn btn-outline-blue">
