    ...
    <div class="col-12 col-md-8">
        <div class="row g-3">
            <div class="col-12">
                ...
                <input type="text" name="name" class="summary-input flex-grow-1 w-100 w-md-auto" value="{{ old('name', $supplier->name ?? '') }}" required>
            </div>
            <div class="col-12">
                <label class="form-label fw-bold">رقم الهاتف</label>
                <input type="text" name="phone" class="summary-input flex-grow-1 w-100 w-md-auto" value="{{ old('phone', $supplier->phone ?? '') }}">
            </div>
            <div class="col-12">
                <label class="form-label fw-bold">العنوان</label>
                <textarea name="address" class="summary-textarea flex-grow-1 w-100 w-md-auto" >{{ old('address', $supplier->address ?? '') }}</textarea>
            </div>
            <div class="col-12">
